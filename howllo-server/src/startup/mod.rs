...
pub fn configure(cfg: &mut web::ServiceConfig) {
    cfg.service(health_check)
        ...
        .service(auth::local_user::register)
        .service(auth::local_user::login)
        .service(auth::local_user::status)
        ...
        .service(auth::customer_auth::public_providers)
        .service(auth::customer_auth::public_rooiam)
        .service(auth::customer_auth::get_settings)
        .service(auth::customer_auth::update_settings)
        .service(auth::customer_auth::save_provider)
        .service(auth::customer_auth::delete_provider)
        .service(auth::oidc::login)
        .service(auth::oidc::callback)
        .service(auth::oidc::exchange)
        ...
        .service(tenancy::set_workspace_publication)
        ...
        .service(memberships::restrictions::list_participants)
        .service(memberships::restrictions::set_restriction)
        .service(memberships::restrictions::clear_restriction)
